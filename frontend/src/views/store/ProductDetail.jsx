                                        ...
                                        <div className="col-md-6 mb-4">
                                            <div className="d-flex">
                                                {size?.map((s, index) => (
                                                    ...
                                                    <button key={index} type='button' onClick={handleSizeButtonClick} className="btn btn-secondary m-1 size_button">{s.name}</button>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <h5 className="card-title">IIann</h5>
                                        <p className="card-text">Marketing Digital</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="card mb-3">
                                        <div className="card-body">
                                            <h5 className="card-title">IIan</h5>
                                            <p className="card-text">June 07, 2024</p>
                                            <p className="card-text">
